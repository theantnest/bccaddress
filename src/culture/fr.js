...
=======
		...
		"bip38alertpassphraserequired": "Mot de passe pour encryption (BIP38) requise",
>>>>>>> master
...
=======
		...
		// header and menu html
		"tagline": "Générateur de porte-monnaie papier Bitcoin Cash hors-ligne",
		"generatelabelbitcoinaddress": "Création de l'adresse Bitcoin Cash...",
		"generatelabelmovemouse": "BOUGEZ votre souris pour ajouter l'entropie nécessaire...",
...
=======
		"footerlabeltranslatedby": "Traduction: checksum0",
>>>>>>> master
		"footerlabelpgp": "PGP",
...
=======
		"statuslabelprotocolbad2": "télécharger", //TODO: please translate
>>>>>>> master
...
=======
		"singlelabelbitcoinaddress": "Adresse Bitcoin Cash:",
		"singlelabelprivatekey": "Clé privée (Format d'importation de porte-monnaie):",
		"singletip1": "Un porte-monnaie Bitcoin Cash est aussi simple qu'une paire de clés cryptographiques dont une correspond est privée est l'autre correspond à l'address Bitcoin Cash. Le porte-monnaie affiché ci-dessus a été généré pour vous dans votre propre navigateur internet.",
		...
		"singletip3": "Pour ajouter des fonds à votre porte-monnaie, envoyez des Bitcoin Cash à votre adresse de réception.",
		"singletip4": "Vous pouvez vérifier le contenu de votre porte-monnaie en consultant blockchair.com et en y tapant votre adresse de réception Bitcoin Cash.",
		"singletip5": "Télécharger un des clients Bitcoin Cash populaires pour dépenser vos Bitcoin cash en y important votre clé privée. Garder à l'esprit que lorsque vous importez une clé privée dans un client et que vous dépenser le contenu, vos fonds seront attaché aux autres clés privés contenu dans le client. Lorsque vous effectez une transaction, votre change sera envoyé vers une autre address Bitcoin Cash déja présente dans le client. Vous devez donc faire une sauvegarde de ce porte-monnaie et le garder en sureté en tout temps puisque le reste de vos fonds y sera contenu. Satoshi suggère de ne jamais effacer un porte-monnaie.",
>>>>>>> master
...
=======
		"paperlabelencrypt": "Encryption BIP38?",
