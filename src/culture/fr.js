(function (translator) {
	translator.translations["fr"] = {
		...
		"singletip4": "<b>Vous pouvez vérifier le contenu de votre porte-monnaie</b> en consultant <a href=\"https://bchexplorer.cash/\">bchexplorer.cash</a> et en y tapant votre adresse de réception Bitcoin Cash.",
		"singletip5": "<b>Télécharger un des <a href=\"https://www.bitcoincash.org/#wallets\">client Bitcoin Cash</a></b> populaires pour dépenser vos Bitcoin cash en y important votre clé privée. Garder à l'esprit que lorsque vous importez une clé privée dans un client et que vous dépenser le contenu, vos fonds seront attaché aux autres clés privés contenu dans le client. Lorsque vous effectez une transaction, votre change sera envoyé vers une autre address Bitcoin Cash déja présente dans le client. Vous devez donc faire une sauvegarde de ce porte-monnaie et le garder en sureté en tout temps puisque le reste de vos fonds y sera contenu. Satoshi suggère de ne jamais effacer un porte-monnaie.",
